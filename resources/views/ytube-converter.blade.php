...
@section('content')
                ...
                <div class="col-12 col-lg-10 mx-auto">
                    <form id="go" class="form-group" action="/en32/download">
                        <div class="has-search">
                            ...
                            <input name="type" value="ytconv" hidden />
    ...
    <section class="pt-5 pb-4 container m-auto">
        <h2 class="text-center mb-4">How to Convert Youtube to MP3/MP4</h2>
            ...
            <div class="col-md-4">
                <div class="icon">
                    ...
                    <div class="icon-text">
                        ...
                        <p class="text-muted">Select a target MP3/MP4 quality and press 'Download' to save the file.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-2 container m-auto">
        <div class="row text-left">
            <div class="col-12">
                <h2 class="text-center">The Best YouTube Converter Online</h2>
                <p>
                    320YTMp3 enables you to download and convert YouTube video to MP3 music with best quality. It is free, reliable and easy to use. In addition, there is no limitation for the downloading. Multiple media formats are supported,
                    including MP4, MP3, FLV, M4V, WMV and WEBM.
                </p>
            </div>
        </div>
    </section>
    <section class="py-2 container m-auto">
        <div class="row text-left">
            <div class="col-12">
                ...
                <p>
                    A cool feature, not well supported by most of similar sites, 320YTMp3 lets you download and convert entire playlist. There is no hassle for software registration and installation. Except YouTube, you could grab your favorite
                    audio/video from 1000+ sites such as Facebook, Vimeo, Dailymotion etc.
                </p>
            </div>
        </div>
    </section>
